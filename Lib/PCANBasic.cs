...
namespace RollingCounterCheck
{
    ...
    public static class PCANBasic
    {
        ...
        /// </summary>
        public const int LAN_DIRECTION_READ = 0x01;
        /// <summary>
        /// The PCAN-Channel is limited to outgoing communication only
        /// </summary>
        public const int LAN_DIRECTION_WRITE = 0x02;
        /// <summary>
        /// The PCAN-Channel communication is bidirectional 
        /// </summary>
        public const int LAN_DIRECTION_READ_WRITE = (LAN_DIRECTION_READ | LAN_DIRECTION_WRITE);
        #endregion
        ...
        /// </summary>
        public const string LOOKUP_DEVICE_GUID = "deviceguid";
        #endregion
